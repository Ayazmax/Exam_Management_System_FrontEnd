...
@Component({
  selector: 'app-p-pro',
  templateUrl: './p-pro.component.html',
  styleUrls: ['./p-pro.component.css']
})
export class PProComponent implements OnInit {
  ...
  updateProfile() {
    ...
    formData.append('interestedBusinessFields', this.userProfile.interestedBusinessFields);
    formData.append('averageIncome', this.userProfile.averageIncome);
